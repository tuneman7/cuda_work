...
echo "*********************************"
echo "*                               *"
echo "*   FINISHED LOCAL TESTING      *"
echo "*                               *"
echo "*********************************"

echo "*********************************"
echo "*                               *"
echo "*   BEGINNING PUBLISH TO AZURE  *"
echo "*                               *"
echo "*********************************"
...
echo "*********************************"
echo "*                               *"
echo "*   PUBLISH TO AZURE  COMPLETE  *"
echo "*                               *"
echo "*********************************"
...
echo "*********************************"
echo "*                               *"
echo "*  RUN CURL REQUESTS AGAINST AZ *"
echo "*                               *"
echo "*********************************"

. curl_az.sh

if [ $BAD_AZ_CURL_TESTING == 1 ]; then
    return
fi
